...
The use of version control systems is essential for effective scientific computing. In Finance 5350, we [make extensive use of Git](http://fonnesbeck.github.io/Finance5350/git.html), which is one of several widely-used versioning systems.
...
We will install everything you require for Finance 5350 in one operation, described in the next section.

## Getting this repository

    git clone https://github.com/fonnesbeck/Finance5350.git
...
This will create an **environment** called `bios5350` that includes the packages required for the course.    
...
***The use of traditional word processing software, such as Microsoft Word or OpenOffice is not permitted in Finance 5350.***
