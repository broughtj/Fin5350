...
In Chapter 2 of \href{https://goo.gl/Kn8M7X}{Python Programming for the
Absolute Beginner}, we are presented with some simple \texttt{Python}
programs to carry out so-called word problems. I reproduce some of
Dawson's examples below in the following code chunks.
